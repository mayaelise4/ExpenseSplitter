...
class InputGoalWidget extends StatefulWidget {
  const InputGoalWidget({super.key});

  @override
  State<InputGoalWidget> createState() => _InputGoalWidgetState();
}

class _InputGoalWidgetState extends State<InputGoalWidget> {
  late InputGoalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InputGoalModel());

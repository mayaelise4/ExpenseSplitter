...
class PocketPageWidget extends StatefulWidget {
  const PocketPageWidget({super.key});

  @override
  State<PocketPageWidget> createState() => _PocketPageWidgetState();
}

class _PocketPageWidgetState extends State<PocketPageWidget> {
  late PocketPageModel _model;
